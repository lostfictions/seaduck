...
const n = new Narrative({
  ...
  actions: [
    {
      match: ["Chris"],
      when: a => a.properties.sleepiness < 10,
      action: function*(a) {
        a.properties.sleepiness++;
        yield new StoryEvent("moreSleepy", a);
      }
    },
    {
      match: ["Chris"],
      when: a => a.properties.sleepiness == 7,
      action: function*(a) {
        yield new StoryEvent("reallySleepy", a);
      }
    },
    {
      ...
      action: function*(a, b) {
        ...
        yield new StoryEvent("getsInto", a, b);
      }
    },
    {
      match: ["Chris", "king-size bed"],
      ...
      action: function*(a, b) {
        yield new StoryEvent("asleep", a, b);
      }
    }
  ],
  traceryDiscourse: {
